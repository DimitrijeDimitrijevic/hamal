defmodule HamalWeb.CoreComponents do
  @moduledoc """
  ...
  # added by Dimitrije
  attr :field_required, :boolean,
    default: false,
    doc: "renders a span under a fields which represents required field"
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(HamalWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(HamalWeb.Gettext, "errors", msg, opts)
    end
  end
